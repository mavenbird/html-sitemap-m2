 ...
 */
namespace Mavenbird\HtmlSiteMap\Helper;

use Magento\Framework\App\Helper\Context;

class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    const MAX_PRODUCTS = 'Mavenbird_HtmlSiteMap/product/max_products';
    const SORT_PRODUCT = 'Mavenbird_HtmlSiteMap/product/sort_product';
    const ORDER_PRODUCT = 'Mavenbird_HtmlSiteMap/product/order_product';
    ...
    {
        $additionUrl = $this->scopeConfig->getValue('Mavenbird_HtmlSiteMap/addition/addition_link', $this->scopeStore);
    ...
    {
        $cmsLink = $this->scopeConfig->getValue('Mavenbird_HtmlSiteMap/cms/do_something', $this->scopeStore);
    ...
    {
        $isEnable = $this->scopeConfig->isSetFlag('Mavenbird_HtmlSiteMap/general/enable', $this->scopeStore);
        return $isEnable;
    }
    ...
    {
        if ($storeId) {
            $value = $this->scopeConfig->getValue('Mavenbird_HtmlSiteMap/general/router', $this->scopeStore, $storeId);
        } else {
            $value = $this->scopeConfig->getValue('Mavenbird_HtmlSiteMap/general/router', $this->scopeStore);
        }
        if (!$value) {
    ...
    {
        return $this->scopeConfig->getValue(
            "Mavenbird_HtmlSiteMap/general/title",
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE
        );
    }
    ...
    {
        return $this->scopeConfig->getValue(
            "Mavenbird_HtmlSiteMap/for_search/description",
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE
        );
    }
    ...
    {
        return $this->scopeConfig->getValue(
            "Mavenbird_HtmlSiteMap/for_search/keywords",
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE
        );
    }
    ...
    {
        return $this->scopeConfig->getValue(
            "Mavenbird_HtmlSiteMap/for_search/meta_title",
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE
        );
    }
    ...
    {
        if ($storeId !== null) {
            $categoryDisable = $this->scopeConfig->getValue('Mavenbird_HtmlSiteMap/category/id_category', $this->scopeStore, $storeId);
        } else {
            $categoryDisable = $this->scopeConfig->getValue('Mavenbird_HtmlSiteMap/category/id_category', $this->scopeStore);
        }
    ...
    {
        $enableCategory = $this->scopeConfig->isSetFlag('Mavenbird_HtmlSiteMap/category/enable_category', $this->scopeStore);
    ...
    {
        $enableProduct = $this->scopeConfig->isSetFlag('Mavenbird_HtmlSiteMap/product/enable_product', $this->scopeStore);
    ...
    {
        $enableCms = $this->scopeConfig->isSetFlag('Mavenbird_HtmlSiteMap/cms/enable_cms', $this->scopeStore);
        return $enableCms;
    }
    ...
    {
        $enableStoreView = $this->scopeConfig->isSetFlag('Mavenbird_HtmlSiteMap/store/enable_store', $this->scopeStore);
    ...
    {
        $orderTemplates = $this->scopeConfig->getValue('Mavenbird_HtmlSiteMap/general/order_templates', $this->scopeStore);
    ...
    {
        $titleCategory = $this->scopeConfig->getValue('Mavenbird_HtmlSiteMap/category/title_category', $this->scopeStore);
    ...
    {
        $showLinkAt = $this->scopeConfig->getValue('Mavenbird_HtmlSiteMap/general/show_link', $this->scopeStore);
    ...
    {
        $titleCms = $this->scopeConfig->getValue('Mavenbird_HtmlSiteMap/cms/title_cms', $this->scopeStore);
    ...
    {
        $titleProduct = $this->scopeConfig->getValue('Mavenbird_HtmlSiteMap/product/title_product', $this->scopeStore);
    ...
    {
        $titleStore = $this->scopeConfig->getValue('Mavenbird_HtmlSiteMap/store/title_store', $this->scopeStore);
    ...
    {
        $titleAddition = $this->scopeConfig->getValue('Mavenbird_HtmlSiteMap/addition/title_addition', $this->scopeStore);
    ...
    {
        $openNewTab = $this->scopeConfig->getValue('Mavenbird_HtmlSiteMap/addition/open_new_tab', $this->scopeStore);
